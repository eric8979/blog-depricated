...
I'm sure that people watching this blog post is already familiar with Vim/neoVim. (If you aren't check this blog first). The logical next step is trying to install and using it. Installing it is easy. 
